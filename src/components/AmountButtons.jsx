...
const AmountButtons = ({ values, onSplitTipChange, onSplitBillChange}) => {
  ...
  return (
    <div className='AmountButtonsMainDiv'>
     ...
     <input className='input' type="text" placeholder="0.00" onChange={handleBill}/>
    ...
    <div className='AmountButtonsSubDiv'>
      ...
      <input className='input' type="text" placeholder="Custom" onChange={handleCustomInputChange}/>
    </div>

    <label>Number of people</label><br/>
    <input className='input' type="text" placeholder="0" onChange={handlePeople}/>
  </div>
  );
};
